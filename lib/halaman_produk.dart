...
Future _getdata() async{
  try {
    final respon = await http.get(Uri.parse('https://aryamobileapi.000webhostapp.com/api_produk/read.php'));
...
Future _hapus(String id) async{
  try {
    final respon = await http.post(Uri.parse('https://aryamobileapi.000webhostapp.com/api_produk/hapus.php'),
    body:{
      "id_produk":id,});
    if(respon.statusCode == 200){
     return false;
...
void initState() { 
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      :ListView.builder(itemCount:_listdata.length,
